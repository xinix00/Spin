...
function contentsButton(artifact){return artifact.snapshot?.contents?`<button class="small-button" data-contents-artifact="${esc(artifact.id)}" title="Alle paden van deze laag, per soort">${icon('inventory_2')}Inhoud</button>`:'';}
