...
function renderLogins(){
  ...
  document.getElementById('logins-title').textContent=`Logins van ${artifactSelector(artifact)}`;
...
document.getElementById('logins-new').onclick=()=>{const artifact=byID(snapshot.artifacts,loginsState.artifactID);if(!artifact)return;closeDialog('logins-dialog');setTab('environments');openConsole();useLayers(artifactSelector(artifact),[],true);};
