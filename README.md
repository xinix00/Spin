...
**Een lopende Job op een nieuwe Template-revisie.** Een Job draait op een kopie van zijn Template, zodat een wijziging aan het Template een lopende Job niet onder zijn voeten verandert. Staat het Template op een nieuwere revisie, dan toont de Job-kaart de knop **Template rN**: die neemt de revisie over, met de keuze om de huidige stap te behouden (als die in de nieuwe revisie nog bestaat) of verder te gaan bij een gekozen stap. Verdergaan bij een andere stap sluit de huidige stap af zonder oordeel ("Overgezet naar stap X"), laat een open vraag vervallen en start de gekozen stap als nieuwe poging; de branch, deliverables en geschiedenis blijven. Zo zet je een Job die vastliep op een Merge-stap om naar een revisie met een AI-merge-stap.
