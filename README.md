...
**Migratie:** het manifestformaat is versie 2. Met een aanwezige lokale database maakt de nieuwe versie automatisch een nieuwe generatie. Een oude bucket zonder lokale database moet eerst met de vorige Spin-versie worden hersteld; laat daarna een volledige versie 2-snapshot maken. Oude generaties worden niet als veilige herstelpunten aangeboden. Dit is vooral van belang bij een leeg HopOS-scratchvolume; zie de [migratie-instructies](replica/README.md#migration-from-the-original-spin-format).
